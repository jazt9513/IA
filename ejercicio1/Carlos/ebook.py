...
class EBook:
  ...
  contenido, titulo, autor, toSplit = '','','',''

  def __init__(self, titulo1, autor1, contenido1,toSplit1):
    self.contenido = contenido1
    self.titulo = titulo1
    self.autor = autor1
    self.toSplit = toSplit1

  def get_diccionario_palabras(self):
    lista = str(self.toSplit).split(' ')
    diccionario = dict({})
